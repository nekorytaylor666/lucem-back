...
import {
  ...
  ExperienceDataInput, ExperienceInput, LanguageInput, WorkTimeInput,
...
const EditDoctorParentMultistepForm = ({ doctorId }: { doctorId: string }) => {
  ...
  const onEditDoctorFormSubmit = (values: EditDoctorFormSchema) => {
    mutateFunction({
      variables: {
        doctorId,
        fullName: values.personalInfo.firstName +
          " " +
  ...
  const steps: TabRoute[] = [
    ...
    },
    {
      ...
      component: <ProfessionalInfo editDoctor={true} onNext={handleNext} onPrev={handleBack} />,
    },
    {
      slug: "education",
      label: "4. Образование",
    ...
    },
    {
      ...
      component: <SpecializationsStep doctorData={doctorData} onNext={handleNext} onPrev={handleBack} />,
    },
    {
      slug: "languages",
      label: "10. Языки",
