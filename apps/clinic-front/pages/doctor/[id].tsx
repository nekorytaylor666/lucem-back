...
const DoctorPage: React.FC<DoctorPageProps> = ({ doctor, price }: DoctorPageProps) => {
  console.log(price);
  return (
    <Layout>
      <AppointmentModal />
      ...
      <main className="container mx-auto p-4">
        <DoctorContentContainer className=" hidden lg:grid  lg:grid-cols-2 gap-x-4">
          ...
          <DoctorDetailsInfo price={price} doctor={doctor}></DoctorDetailsInfo>
...
const DoctorDetailsInfo = (props: { doctor: GetDoctorByID_getDoctorByID, price: number }) => {
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const { data: serviceRes } = await client.query({ query: GET_SERVICE_BY_ID, variables: { serviceId: "618c0c4985b2fd7b37e3656e" } })
