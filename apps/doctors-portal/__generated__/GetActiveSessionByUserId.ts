...
export interface GetActiveSessionByUserId_getActiveSessionByUserId_booking_doctor {
    __typename: "Doctor";
    _id: string;
}
...
export interface GetActiveSessionByUserId_getActiveSessionByUserId_booking {
    ...
    doctor: GetActiveSessionByUserId_getActiveSessionByUserId_booking_doctor | null;
}
