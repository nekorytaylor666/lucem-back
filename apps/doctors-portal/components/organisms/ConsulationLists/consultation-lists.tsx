...
const AppointmentLists: React.FC<{
    appointments: GetAppointmentBlanksOfUser_getAppointmentBlanksOfUser[];
    onAppointmentClick: (
        appoitment: GetAppointmentBlanksOfUser_getAppointmentBlanksOfUser,
    ) => void;
...
const AppointmentItem = ({
    ...
    appointment: GetAppointmentBlanksOfUser_getAppointmentBlanksOfUser;
    onAppointmentClick: (
        appointment: GetAppointmentBlanksOfUser_getAppointmentBlanksOfUser,
    ) => void;
}) => (
            ...
            <div className="mb-4">
                ...
                <div
                    dangerouslySetInnerHTML={{
                        __html: toCleanHtml(
                            appointment.diagnose?.deseaseDBCode ?? "",
                        ),
                    }}
                />
            </div>
