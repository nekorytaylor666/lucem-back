...
import { LOGIN_DOCTOR } from "@services/graphql/queries/LoginDoctor";

const Login = () => {
    const router = useRouter();
    const [loginDoctor, { loading, error, data }] = useLazyQuery(LOGIN_DOCTOR, {
        onCompleted: (data) => {
            localStorage.setItem("DOCTOR_TOKEN", data.loginDoctor.token);
            localStorage.setItem("DOCTOR_ID", data.loginDoctor.doctor._id);
            router.push("/");
        },
    });
    return (
