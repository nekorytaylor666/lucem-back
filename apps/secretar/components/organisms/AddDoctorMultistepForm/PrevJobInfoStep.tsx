...
const JobExperiencesFieldArray: FC<FieldArrayRenderProps> = (props) => {
    ...
    const onAdd = () => {
        push({ companyName: "", speciality: "", startYear: "", endYear: "" });
    };
    return (
        <>
                ...
                <div className="space-y-2 ">
                    ...
                    <div>
                        ...
                        <Field
                            ...
                            name={`jobExperienceInfo[${index}].companyName`}
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-2">
                            <Field
                                type="text"
                                name={`jobExperienceInfo[${index}].startYear`}
                                placeholder="C"
                            ...
                            <Field
                                type="text"
                                placeholder="По"
                                name={`jobExperienceInfo[${index}].endYear`}
                                className="input bg-gray-100"
                            />
                        </div>
                    </div>
