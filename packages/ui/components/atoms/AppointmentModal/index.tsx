          ...
          >
            <StyledModalContainer className="py-8 px-6 bg-gray-100 rounded-2xl w-5/12 space-y-4">
              <div className="flex justify-between">
                <div>
                  <p className="text-3xl font-bold">Запись на прием</p>
                </div>
              ...
              <div className="flex">
                <div className="flex-1 flex flex-col items-center">
                  ...
                  <div className="flex justify-center mt-4">
                    <div className="flex space-x-2">
                      <Image height={24} width={24} src="/icons/star.svg" />
                      <Image height={24} width={24} src="/icons/star.svg" />
                      <Image height={24} width={24} src="/icons/star.svg" />
                      <Image height={24} width={24} src="/icons/star.svg" />
                      <Image height={24} width={24} src="/icons/star.svg" />
                ...
                <div className="flex flex-1 flex-col items-center">
                  <div>
                    <p className="text-dark-grey">Кардиолог</p>
                    <p className="text-xl font-bold">
                      Рыспаева Алия Шаяхметовна
                    </p>
                    <p>
                      Стаж 33 года | Врач высшей категории | Кандидат
                      медицинских наук
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-2">
                  <div className="flex-1 space-y-2">
                    <p className="text-dark-grey">Дата рождения пациента</p>
                    <input
                      type="text"
                      className="px-2 py-3 w-full border border-gray-300 focus:outline-none focus:border-pink-purple rounded"
                  ...
                  <div className="flex-1 space-y-2">
                    <p className="text-dark-grey">Дата и время приема</p>
                    <input
                      type="text"
                      className="px-2 py-3 w-full border border-gray-300 focus:outline-none focus:border-pink-purple rounded"
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-dark-grey text-sm">
                    На этот номер вам придет SMS с кодом подтверждения
                  </p>
                </div>
                {appointmentSent ? (
                  <div>
                    <p className="text-pink-purple text-sm">
                      Отправить еще раз через <span>{seconds}</span> секунд
                    </p>
                  ...
                  <div>
                    <button
                      ...
                      onClick={() => setAppointmentSent(!appointmentSent)}
                    >
