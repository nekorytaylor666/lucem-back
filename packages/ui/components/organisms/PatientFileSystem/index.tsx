...
// import { GET_APPOINTMENTS_INFO } from "@src/api/queries/appointment-blank.queries";
...
//         variables: { userId },
//     });
//     const sessionsAndDiagnoses = data.getDiagnoseOfUser.map(
//         ({ diagnose, session }) => ({
//             diagnose,
...
//                             }}
//                             onSubmit={({ file, description, sessionId }) => {
//                                 mutate({
//                                     context: {
//                                         headers: {
//                                             Authorization: token,
...
export const PatientFileUploadInput = ({ onChange }) => {
  ...
  return (
    <div>
      <label className="px-4 py-8 rounded-xl bg-white text-base-300 flex justify-center items-center">
        <div className="flex justify-center items-center w-2/3">
          {file ? (
            ...
            <>
              ...
              <p>
                Перетащите файл сюда, или нажмите для выбора файла с устройства
              </p>
            </>
          )}
        </div>
